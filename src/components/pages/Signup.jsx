      ...
      <section>
        ...
        <div className='flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto'>
          <div className='md:w-[67%] lg:w-[50%] mb-12 md:mb-6'>
            <img src="https://images.unsplash.com/flagged/photo-1564767609342-620cb19b2357?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxzZWFyY2h8Mnx8a2V5fGVufDB8fDB8fA%3D%3D&auto=format&fit=crop&w=800&q=60"
            alt="key"
          ...
          <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
            <form >
             ...
             <input type="email" id="email" value={email}
              ...
              { showPassword? (<AiFillEyeInvisible className='absolute right-3 top-3
            ...
            hover:shadow-lg
            active:bg-blue-800'> Sign in
  
            </button>
            <div className='flex my-4 items-center before:border-t 
            before:flex-1 
